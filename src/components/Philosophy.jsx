...
export default function Philosophy() {
  const promises = [
    {
      num: '01',
      title: '돼지기름 없이, 직접 만든 식물성 기름',
      photoTitle: '사진 공간',
      photoDesc: '야채 활용 기름 만드는 장면 또는 짧은 조리 영상',
      imgSrc: '/dol_zzajang_main.png',
    ...
    },
    {
      ...
      title: '주문마다 따로 조리',
      photoTitle: '사진 공간',
      photoDesc: '주문마다 따로 조리하는 웍 또는 돌판 장면',
      imgSrc: '/mugeunji_dol_zzajang.png',
      desc1: '한 번에 많이 만들어 덜어내지 않고, 주문한 메뉴마다 따로 조리합니다.',
    ...
    },
    {
      ...
      imgSrc: '/chubu_perilla_zzajang.png',
      ...
      <div className="container">
        ...
        <div className="section-header text-center animate-fade-in-up">
          ...
          <h2 className="philosophy-main-title">
            ...
            그러나 우리는 <span className="time-highlight">201시간</span>을<br />
            준비합니다.
          </h2>

          <div className="time-pill-badge">
            <span>9시간 상황버섯 달임 + 192시간 저온 숙성</span>
          </div>

          <h3 className="five-promises-heading">산내돌짜장의 고집, 5가지</h3>
